...
FROM restRest_table C1
INNER JOIN restBill C2
...
AS SELECT CONCAT(D3.first_name, ' ' ,D3.surname) AS headwaiter_name, SUM(bill_total) AS total_sum
FROM restStaff D1
INNER JOIN restBill D2
ON D1.staff_no = D2.waiter_no
INNER JOIN restStaff D3
ON D1.headwaiter = D3.staff_no
